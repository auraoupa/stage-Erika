...
curlfile00=dirvar00+'eNATL60ACO-BLB002_y2009m*_socurloverf10m_filt2T_unlimited.nc' # JFM
strainfile00=dirvar00+'eNATL60ACO-BLB002_y2009m*_sostrainoverf10m_filt2T_unlimited.nc' # JFM
...
curl00=dscurl00.Curl_noTide_Filt
...
for t in np.arange(len(date_list)):
	print('writing file eNATL60ACO-BLB002_'+date_list[t]+'_ow10m_filt2T.nc')
	ow00_1day = ow00.squeeze()[24*t:24*(t+1)]
	ow00_da=xr.DataArray(ow00_1day,dims=['time_counter','y','x'],name="ow00_noTide_Filt")
	ow00_da.attrs['Name']='eNATL60ACO-BLB002_'+date_list[t]+'_ow10m_filt2T.nc'
	ow00_da.to_dataset().to_netcdf(path='/scratch/cnt0024/hmg2840/albert7a/eNATL60/eNATL60-BLB002-S/1h/ACO/eNATL60ACO-BLB002_'+date_list[t]+'_ow10m_filt2T.nc',mode='w')
