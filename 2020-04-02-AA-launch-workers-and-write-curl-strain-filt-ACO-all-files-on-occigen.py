...
print ('debut curl no tide : '+str(datetime.now()))
curl00_filt_da=xr.DataArray(curl00_filt.squeeze(),dims=['time_counter','y','x'],name="Curl_noTide_Filt")
...
print ('fin curl no tide, debut strain tide : '+str(datetime.now()))
strainT0_filt_da=xr.DataArray(strainT0_filt.squeeze(),dims=['time_counter','y','x'],name="strain_Tide_Filt")
...
print ('fin strain tide, debut strain no tide : '+str(datetime.now()))
strain00_filt_da=xr.DataArray(strain00_filt.squeeze(),dims=['time_counter','y','x'],name="strain_noTide_Filt")
...
print ('fin de lecriture : '+str(datetime.now()))
